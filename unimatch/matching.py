# Copyright (c) 2022 autonomousvision. MIT License
# https://github.com/autonomousvision/unimatch/blob/master/unimatch/matching.py
...
def local_correlation_softmax(feature0, feature1, local_radius,
    ...
    window_feature = F.grid_sample(feature1.contiguous(), sample_coords_norm,
